...
| [ROADMAP.md](./ROADMAP.md) | 新增 MetaSoul 重命名任务、SoulTeam 新建任务、FLY 层整合任务 |
...
| [docs/plan/README.md](./plan/README.md) | 更新归档声明，指向 Mission.md |
...
- 实现 TeamOrchestrator（基于 SwarmFly CollaborationEngine 扩展）
- 实现八卦路由和协作链模板
...
- [E2E_OPTIMIZATION_DESIGN.md](./E2E_OPTIMIZATION_DESIGN.md) - 优化模块设计
- [E2E-Plan.md](./E2E-Plan.md) - 端到端测试计划
- [design/agent-collaboration/](./design/agent-collaboration/) - 多智能体协作设计文档
